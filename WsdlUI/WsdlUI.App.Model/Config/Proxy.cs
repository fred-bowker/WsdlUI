...
namespace WsdlUI.App.Model.Config {
    public class Proxy : ConfigItem, Pickle.IModelPickle, drexModel.IProxy  {
        ...
        drexModel.Proxy.EProxyType _proxyType;
        public drexModel.Proxy.EProxyType ProxyType {
            get {
                return _proxyType;
            }
            set {
        ...
        public Proxy() {
            _port = 8888;
            _host = "127.0.0.1";
            _proxyType = drexModel.Proxy.EProxyType.System;
        }
        ...
        void Pickle.IModelPickle.Deserialize(string[] serializedData) {
            ...
            _proxyType = (drexModel.Proxy.EProxyType)Enum.Parse(typeof(drexModel.Proxy.EProxyType), proxySetting);
        }
